...
public struct Recipe: Decodable {
    ...
    public init(from dto: RecipeDTO) {
        self.id = Int(dto.id)
        self.name = dto.name
        self.ingredients = dto.ingredients
        self.instructions = dto.instructions
        self.prepTimeMinutes = Int(dto.prepTimeMinutes)
        self.cookTimeMinutes = Int(dto.cookTimeMinutes)
        self.servings = Int(dto.servings)
        self.difficulty = Difficulty(rawValue: dto.difficulty) ?? .unknown
        self.cuisine = dto.cuisine
        self.caloriesPerServing = Int(dto.caloriesPerServing)
        self.tags = dto.tags
        self.userID = Int(dto.userID)
        self.image = dto.image
        self.rating = dto.rating
        self.reviewCount = Int(dto.reviewCount)
